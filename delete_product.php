    ...
    <div class="row">
      <div class="col-sm-9 col-md-5 col-lg-8 mx-auto">
        <div class="card card-signin my-5">
          <div class="card-body" >
              <h5 class="card-title text-center" style="color: blue; font-weight: bolder;">DELETE PRODUCT</h5> 
              <?php 
                 if (@$_GET['Empty']==true)
                 {
                   ?>
 ...
 <form action="" method="post">
  <div class="form-row">
    ...
    <div class="form-group col-md-6">
      ...
      <input type="text" class="form-control" id="idn" name="bnum" value="<?php echo$row['price'] ?>" readonly="readonly">
    </div>
    </div>
...
<div >
     <button type="submit" name="add" class="btn   btn-danger">Delete Product</button>
  </div>
</form>
</div>
 </div>
...
$sql = "DELETE FROM `image` WHERE `name`= '".$_POST['bo']."'";
