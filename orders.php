...
?>
 <div class="card-link align-right" style="text-transform: uppercase; float: left; padding-right: 20px; padding-left: 0px;">
	 <a href="products.php" style="color: white;font-weight: bolder;" >Edit  Products  </a>
	 </div>
...
$query=mysqli_query($con,"SELECT  `email`, `name`, `price`, `quantity`,`status`,`ordn`,`location`, `contacts` FROM `purchase` order by `status` desc");
...
<td style="text-align: center;" >
  <a href="verification.php?off=<?php echo $row["ordn"]; ?>"><i class="fa fa-check-circle fa-2x"></i></a>
</td>
		</tr>
	<?php } ?>
	</table>
